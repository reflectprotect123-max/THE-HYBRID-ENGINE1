 ...
 * third shape, `StrengthBlock` from `@hybrid/strength-engine`, on the same
 * day Phase A closed. `heading` is common to all three block shapes, so
 * reads of it below need no cast — this screen still only CONSTRUCTS or
 * edits a CondBlock/TextBlock, not a `StrengthBlock`.
 */
