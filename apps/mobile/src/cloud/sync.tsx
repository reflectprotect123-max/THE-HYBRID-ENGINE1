...
interface SyncCtx {
  ...
  /* `reportHeldSessions` was declared here until 14 August 2026. It told the
     coach that the safety layer had stopped one of their sessions, so a hold
     could not be mistaken for a workout the athlete ignored. It went with
     `@hybrid/auto-coach`: nothing decides a hold now, so there is nothing to
     report. The server side (`push_autocoach_receipt`, widened to accept
     'held') is untouched and still accepts them — see CLAUDE.md. */
}
