...
import { NUTRITION_LS_KEY, NutritionProvider, saveNutrition } from '../src/store/nutrition';
...
} from '../src/store/scanCorpus';
import { FoodScreen } from '../src/screens/nutrition/Food';
import type { MlkitRecognitionResult, MlkitTextBlock } from '../src/native/labelOcr';
