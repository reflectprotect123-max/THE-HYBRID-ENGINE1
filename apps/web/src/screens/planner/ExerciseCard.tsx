...
/**
 * One exercise, as a card — collapsed to a single line until opened, same
 * pattern as the coach builder's `ExCard`. Split out of `Planner.tsx`, which
 * had grown past 500 lines doing every block kind's job in one file.
 */
export function ExerciseCard({
  ...
  /** Which datalist this movement name should offer — prep-first inside a
      warm-up block, logged movements everywhere else. Undefined when read-only,
      since a read-only field has nothing to suggest into. */
