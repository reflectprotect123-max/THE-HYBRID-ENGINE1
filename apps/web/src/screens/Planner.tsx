                      ...
                      <ExerciseCard
                        ...
                        onAddSet={() =>
                          edit((d) => {
                            ...
                            // Inherit the exercise's own pct1rm shape, if it
                            // has one — otherwise a set added to a % mode
                            // exercise silently has no prescription: no
                            // badge here, excluded from the RPE-ramp spread,
                            // and the Logger falls through to the ordinary
                            // earned-weight path for this set alone. Cloned,
                            // not shared — same rule onPctChange follows.
                        ...
                        onModeChange={(mode) =>
                          edit((d) => {
                            ...
                            if (mode === 'seconds' || mode === 'reps') {
                              ...
                              // and force range's hi off of lo so each survives
                              // being read straight back.
                              e2.sets = e2.sets.map((s) => {
