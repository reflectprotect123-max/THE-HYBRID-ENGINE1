      ...
      <div className="grid gap-4 p-3 sm:p-4 xl:grid-cols-[minmax(0,1fr)_300px]">
        <div className="min-w-0 space-y-5">
          <section aria-labelledby="client-overview-title">
            ...
            <nav className="mt-2 flex gap-1 overflow-x-auto text-xs" aria-label={`${selectedClient.name} details`}><span aria-current="page" className="min-h-8 shrink-0 rounded-md border border-line2 bg-panel px-2 py-1.5 text-text">Summary</span>{selectedClient.source === 'engine-local' ? <><Link to={`/coach/review/${weeklyPlan.weekStart}`} className="min-h-8 shrink-0 rounded-md border border-transparent px-2 py-1.5 text-muted hover:bg-panel hover:text-text">Week</Link><Link to="/coach/progression" className="min-h-8 shrink-0 rounded-md border border-transparent px-2 py-1.5 text-muted hover:bg-panel hover:text-text">Decisions</Link><Link to="/coach/nutrition" className="min-h-8 shrink-0 rounded-md border border-transparent px-2 py-1.5 text-muted hover:bg-panel hover:text-text">Nutrition</Link><Link to="/coach/legacy" className="min-h-8 shrink-0 rounded-md border border-transparent px-2 py-1.5 text-muted hover:bg-panel hover:text-text">Inspect details</Link></> : <span className="px-2 py-1.5 text-dim">Detailed records await the backend adapter</span>}</nav>
          </section>
