...
import { buildCoachNutritionReview } from '../data/nutrition-review';
...
import type { AthleteNutritionSummary, AthleteProgressionProposal, AthleteWeekSummary, ClientSummary } from '../data/contracts';
import { localWeek, rosterWeek } from '../data/command-week';
import { CommandWeek } from '../components/CommandWeek';
