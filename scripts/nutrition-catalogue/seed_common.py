...
# supabase/migrations/20260807_macrotrack_food_catalogue.sql creates
# public.foods with these columns in addition to the original eleven-column
# contract that `--legacy-schema` still emits.
