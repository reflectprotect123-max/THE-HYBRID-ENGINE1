...
async function run() {
  ...
  if (index) {
    ...
    const behaviorPatterns = [
      ...
      [/glogConfirmSet\(/, 'guided set confirm'],
      [/computeSetAdjustment\(/, 'per-set RPE autoregulation'],
      [/startRest\(restSec\)/, 'rest auto-starts on set confirm'],
      ...
      [/glogRpeSlider/, 'actual-RPE slider (1–10)'],
