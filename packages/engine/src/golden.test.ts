...
import condEffortV from '../test/golden/condEffort.json';
import condGapV from '../test/golden/condEffortGap.json';
import condRpeV from '../test/golden/condEffortRpe.json';
import maxHrV from '../test/golden/conMaxHr.json';
import zonesV from '../test/golden/conZones.json';
import zoneOfV from '../test/golden/conZoneOf.json';
import recBandV from '../test/golden/recoveryBand.json';
...
import mergeV from '../test/golden/mergeEngines.json';
import constV from '../test/golden/constants.json';
